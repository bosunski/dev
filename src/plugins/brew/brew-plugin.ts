...
import { BrewConfigProvider } from './brew-config-provider.js'
import type { Dev } from '../../dev.js'

export class BrewPlugin implements PluginInterface, Capable {
  ...
  capabilities(): Partial<Record<CapabilityKey, new (args: Record<string, unknown>) => Capability>> {
    return { [CONFIG_PROVIDER]: BrewConfigProvider }
  }
}
