...
import { CONFIG_PROVIDER } from '../../types/capability.js'
import { DopplerConfigProvider } from './doppler-config-provider.js'
import type { Dev } from '../../dev.js'

export class DopplerPlugin implements PluginInterface, Capable {
  ...
  capabilities(): Partial<Record<CapabilityKey, new (args: Record<string, unknown>) => Capability>> {
    return { [CONFIG_PROVIDER]: DopplerConfigProvider }
  }
}
