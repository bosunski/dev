...
class StartContainerStep implements Step
{
    ...
    public function run(Runner $runner): bool
    {
        ...
        $command = "docker run --rm -v $dataDir:/var/lib/mysql -l dev.orbstack.domains=mysql.dev.local --name dev-mysql -p 127.0.0.1:3306:3306 -e MYSQL_ALLOW_EMPTY_PASSWORD='yes' -d mysql:8.3.0 --max-allowed-packet=512M";
